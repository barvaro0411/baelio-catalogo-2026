// ===================================
// BAELIO 2026 - Product Database with Real Notes & Seasonal Recommendations
// ===================================
...
const products = [
    ...
    { code: 'Q51', name: 'Santal 33', category: 'black-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Sándalo australiano, cedro, cardamomo, iris, violeta. Ideal para: Todo el año, unisex culto' },
    { code: 'Q52', name: 'Ombré Leather', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Cuero negro, jazmín sambac, pachulí, ámbar. Ideal para: Otoño-Invierno, cuero intenso' },
    { code: 'Q53', name: 'Silver Mountain Water', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Bergamota, té verde, grosella negra, almizcle. Ideal para: Primavera-Verano, alpino fresco' },
    { code: 'Q54', name: 'Aventus', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Piña, bergamota, manzana, pachulí, vainilla. Ideal para: Todo el año, icónico poderoso' },
    { code: 'Q55', name: 'Neroli Portofino', category: 'black-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Neroli, bergamota, limón, ámbar, almizcle. Ideal para: Primavera-Verano, mediterráneo elegante' },
    { code: 'Q56', name: 'Born in Roma Uomo', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Violeta, jengibre, vetiver, sal mineral. Ideal para: Todo el año, sofisticación romana' },
    { code: 'Q57', name: 'Erba Pura', category: 'black-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Naranja, limón, frutas, vainilla, almizcle. Ideal para: Primavera-Verano, dulzura mediterránea' },
    { code: 'Q58', name: "L'immensité", category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Lavanda, salvia, pomelo, ámbar gris. Ideal para: Todo el año, inmensidad aromática' },
    { code: 'Q59', name: 'Marly Althair', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Notas: Vainilla bourbon, cardamomo, canela, ámbar. Ideal para: Otoño-Invierno, oriental elegante' },

    // RED PARFUMS - LÍNEA PREMIUM (Q01-Q09)
    { code: 'Q01', name: 'English Pear and Freesia', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Notas: Pera, fresia, rosa, pachulí, ámbar. Ideal para: Primavera-Verano, frutal elegante' },
    { code: 'Q02', name: 'Black Orchid', category: 'red-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Orquídea negra, trufa, ylang-ylang, pachulí. Ideal para: Otoño-Invierno, lujo oscuro' },
    { code: 'Q03', name: "Love Don't Be Shy", category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Notas: Marshmallow, naranja, jazmín, almizcle. Ideal para: Todo el año, dulzura adictiva' },
    { code: 'Q04', name: 'Soleil Blanc', category: 'red-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Bergamota, pimienta rosa, coco, ámbar. Ideal para: Verano, sol blanco tropical' },
    { code: 'Q05', name: 'Baccarat Rouge', category: 'red-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Azafrán, jazmín, ámbar gris, cedro. Ideal para: Todo el año, lujo absoluto' },
    { code: 'Q06', name: 'Bianco Latte', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Notas: Leche, vainilla, almizcle blanco, sándalo. Ideal para: Otoño-Invierno, cremosidad láctea' },
    { code: 'Q07', name: 'Oriana', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Notas: Bergamota, frutas, vainilla, almizcle. Ideal para: Primavera-Verano, dulzura floral' },
    { code: 'Q08', name: 'Attrape-Rêves', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Notas: Pera, rosa, pachulí, vainilla. Ideal para: Todo el año, atrapasueños elegante' },
    { code: 'Q09', name: 'Bleecker Street', category: 'red-premium', gender: 'unisex', sizes: '100ml', description: 'Notas: Violeta, cachemira, cedro, vainilla. Ideal para: Otoño-Invierno, elegancia urbana' },

    // JUVENILES TEEN (J00-J09)
    { code: 'J00', name: 'Cloud', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Lavanda, pera, coco, praliné, vainilla. Ideal para: Todo el año, dulce celestial' },
    { code: 'J01', name: 'Fantasy', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Kiwi, lichi, cupcake, chocolate blanco. Ideal para: Primavera-Verano, fantasía' },
    { code: 'J02', name: 'Selena', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Frutas, flores, vainilla, almizcle. Ideal para: Todo el año, vibrante' },
    { code: 'J03', name: 'Bombshell', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Fresa, peonía, vainilla, almizcle. Ideal para: Primavera-Verano, explosión' },
    { code: 'J04', name: 'Thank You Next', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Pera, frambuesa, coco, rosa. Ideal para: Primavera-Verano, modernidad' },
    { code: 'J05', name: 'Meow', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Frutas dulces, flores, vainilla. Ideal para: Todo el año, juguetón' },
    { code: 'J06', name: 'Sweet Like Candy', category: 'teen', gender: 'mujer', sizes: '50ml', description: 'Género: Mujer. Notas: Grosella negra, marshmallow, vainilla. Ideal para: Otoño-Invierno, caramelo' },
    { code: 'J07', name: 'Legacy', category: 'teen', gender: 'hombre', sizes: '50ml', description: 'Género: Hombre. Notas: Frutas, flores, almizcle. Ideal para: Todo el año, legado joven' },
    { code: 'J08', name: 'Spirit of the Brave', category: 'teen', gender: 'hombre', sizes: '50ml', description: 'Género: Hombre. Notas: Manzana, lavanda, cedro. Ideal para: Todo el año, espíritu valiente' },
    { code: 'J09', name: 'Invictus Aqua', category: 'teen', gender: 'hombre', sizes: '50ml', description: 'Género: Hombre. Notas: Pomelo, hoja de laurel, ámbar gris. Ideal para: Primavera-Verano, acuático fresco' },
...
function renderProducts() {
    ...
    productsGrid.innerHTML = filteredProducts.map((product, index) => `
        <div class="product-card" ${product.gender ? `data-gender="${product.gender}"` : ''} style="animation-delay: ${index * 0.05}s">
