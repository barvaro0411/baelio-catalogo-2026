...
const allProducts = [
    ...
    // BLACK PARFUMS - LÍNEA PREMIUM (Q51-Q59) - Usan envase de HOMBRE
    { code: 'Q51', name: 'Santal 33', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Unisex. Notas: Sándalo australiano, cedro, cardamomo, iris, violeta. Ideal para: Todo el año, culto' },
    { code: 'Q52', name: 'Ombré Leather', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Unisex. Notas: Cuero negro, jazmín sambac, pachulí, ámbar. Ideal para: Otoño-Invierno, intenso' },
    { code: 'Q53', name: 'Silver Mountain Water', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Unisex. Notas: Bergamota, té verde, grosella negra, almizcle. Ideal para: Primavera-Verano, fresco' },
    { code: 'Q54', name: 'Aventus', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Hombre. Notas: Piña, bergamota, manzana, pachulí, vainilla. Ideal para: Todo el año, poderoso' },
    { code: 'Q55', name: 'Neroli Portofino', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Unisex. Notas: Neroli, bergamota, limón, ámbar, almizcle. Ideal para: Primavera-Verano, elegante' },
    { code: 'Q56', name: 'Born in Roma Uomo', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Hombre. Notas: Violeta, jengibre, vetiver, sal mineral. Ideal para: Todo el año, romano' },
    { code: 'Q57', name: 'Erba Pura', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Unisex. Notas: Naranja, limón, frutas, vainilla, almizcle. Ideal para: Primavera-Verano, dulce' },
    { code: 'Q58', name: "L'immensité", category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Hombre. Notas: Lavanda, salvia, pomelo, ámbar gris. Ideal para: Todo el año, aromático' },
    { code: 'Q59', name: 'Marly Althair', category: 'black-premium', gender: 'hombre', sizes: '100ml', description: 'Género: Hombre. Notas: Vainilla bourbon, cardamomo, canela, ámbar. Ideal para: Otoño-Invierno, elegante' },

    // RED PARFUMS - LÍNEA PREMIUM (Q01-Q09) - Usan envase de MUJER
    { code: 'Q01', name: 'English Pear and Freesia', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Mujer. Notas: Pera, fresia, rosa, pachulí, ámbar. Ideal para: Primavera-Verano, frutal' },
    { code: 'Q02', name: 'Black Orchid', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Unisex. Notas: Orquídea negra, trufa, ylang-ylang, pachulí. Ideal para: Otoño-Invierno, lujoso' },
    { code: 'Q03', name: "Love Don't Be Shy", category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Mujer. Notas: Marshmallow, naranja, jazmín, almizcle. Ideal para: Todo el año, dulce' },
    { code: 'Q04', name: 'Soleil Blanc', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Unisex. Notas: Bergamota, pimienta rosa, coco, ámbar. Ideal para: Verano, tropical' },
    { code: 'Q05', name: 'Baccarat Rouge', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Unisex. Notas: Azafrán, jazmín, ámbar gris, cedro. Ideal para: Todo el año, lujo absoluto' },
    { code: 'Q06', name: 'Bianco Latte', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Mujer/Unisex. Notas: Leche, vainilla, almizcle blanco, sándalo. Ideal para: Otoño-Invierno, cremoso' },
    { code: 'Q07', name: 'Oriana', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Mujer. Notas: Bergamota, frutas, vainilla, almizcle. Ideal para: Primavera-Verano, floral' },
    { code: 'Q08', name: 'Attrape-Rêves', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Mujer. Notas: Pera, rosa, pachulí, vainilla. Ideal para: Todo el año, elegante' },
    { code: 'Q09', name: 'Bleecker Street', category: 'red-premium', gender: 'mujer', sizes: '100ml', description: 'Género: Unisex. Notas: Violeta, cachemira, cedro, vainilla. Ideal para: Otoño-Invierno, urbano' },
...
// Filter only premium perfumes (Black & Red)
const products = allProducts.filter(p => p.category === 'black-premium' || p.category === 'red-premium');
